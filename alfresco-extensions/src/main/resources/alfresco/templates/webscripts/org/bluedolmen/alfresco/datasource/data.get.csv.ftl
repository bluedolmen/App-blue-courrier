...
<#compress>
<#assign displayTitleLine=((args.omitTitleLine!"false")?string != "true")>
<#if args['with-bom']?? && 'true' == args['with-bom']>${'\xfeff'}</#if><#if displayTitleLine><#list fields as field>"${field.label!field.name}"<#if field_has_next>,</#if></#list></#if>
