...
<form action="${url.context}/service/bluedolmen/init/${status.id}/action" method="post">
	<input type="hidden" name="init-id" value="${status.id}"/>
	<input type="hidden" name="redirect" value="${url.context}/service/bluedolmen/init/list?format=html"/>
