...
var ParseArgs = {
	...
	parse : function() {
		...
		if (null == datasourceId) {
			...
			status = status.setCode(400, message);
			return null;
		}
		...
		function getMixins() {
			...
			var mixinsParam = args['mixins'];
			if (null == mixinsParam) return [];
			
			return Utils.String.splitToTrimmedStringArray(mixinsParam);
