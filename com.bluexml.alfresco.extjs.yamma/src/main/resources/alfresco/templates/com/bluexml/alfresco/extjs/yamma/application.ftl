...
<@templateHeader >
	...
	<@link rel="stylesheet" type="text/css" href="${url.context}/res/bluexml/resources/css/extjs-custom.css" />
	<@link rel="stylesheet" type="text/css" href="${url.context}/res/bluexml/resources/css/icons.css" />
...
<body>
	...
	<div id="loading">
		...
		<div id="logo-bluexml"></div><div id="loading-indicator"></div>
	</div>
