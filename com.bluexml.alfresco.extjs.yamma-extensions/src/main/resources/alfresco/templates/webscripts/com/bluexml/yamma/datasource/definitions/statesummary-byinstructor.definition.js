	...
	DatasourceDefinitions.register('StateSummaryByInstructor',
		{
			...
			searchAdditional : {
				...
				datasource : 'Mails',
				groupBy : YammaModel.YAMMA_NS_PREFIX + ':Assignable_authority'
				...
				
				{
					...
					evaluate : function(creator, operation, values) {
						...
						switch (operation) {
							case 'compute':
								this.documentNumber++;
								var documentState = values[YammaModel.STATUSABLE_STATE_PROPNAME] || YammaModel.DOCUMENT_STATE_UNKNOWN;
