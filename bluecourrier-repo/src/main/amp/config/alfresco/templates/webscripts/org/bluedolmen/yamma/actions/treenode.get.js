		...
		if ('root' == treeNodeRef) { // root-node => get sites
			var children = getServicesNodes(
				...
				getSelectNodeDescendantNumberFunction(
					".//*[subtypeOf('" + YammaModel.TRAY_TYPE_SHORTNAME + "')]//*[hasAspect('" + YammaModel.DOCUMENT_ASPECT_SHORTNAME + "')]"
				)
