...
//					
//					return ({
//						state : document.properties[YammaModel.STATUSABLE_STATUS_PROPNAME] || ''
//					});
//					
//				}				
			...
			fields : [
				...
				{
					name : YammaModel.MAIL_ASPECT_SHORTNAME + '_author',
					type : 'string',
				 ...
				 */
				{
					...
					evaluate : function(reply) {
						...
						return repliedDocument.properties[YammaModel.STATUSABLE_STATUS_PROPNAME] || '';
					}
				},
				
				{
					name : YammaModel.OUTBOUND_DOCUMENT_ASPECT_SHORTNAME + '_signedContent',
					type : 'boolean',
					evaluate : function(reply) {
