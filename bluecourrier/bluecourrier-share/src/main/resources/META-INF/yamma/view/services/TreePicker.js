/**
 * @class Ext.ux.form.field.TreePicker
 * @extends Ext.form.field.Picker
 * 
 * A Picker field that contains a tree panel on its popup, enabling selection of tree nodes.
 * 
 * Brice Pajot (bpajot@bluexml.com)
 * 2013-01-04: Customization of the file (do not show root if not necessary)
 */
Ext.define('Ext.ux.form.field.TreePicker', {
    ...
    config: {
        ...
        /**
         * @cfg {Object} treePanelExtraConfig
         */
        treePanelExtraConfig : null        
    ...
    createPicker: function() {	
        var me = this,
            ...
            picker = Ext.create('Ext.tree.Panel', 
            	Ext.apply(treePanelConfig, me.treePanelExtraConfig)
            ),
            view = picker.getView()
		;
