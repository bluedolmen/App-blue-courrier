(function() {
	...
	const
		...
		ACKNOWLEDGMENT_TEMPLATE_NAME = "incoming-acknowledgment.html.ftl"
	;
	...
	ImapMailUtils = {
		...
		mapImapMail : function(imapMail, yammaMail) {
			...
			function mapMessageFrom() {
				...
				yammaMail.properties[YammaModel.SENDER_INSTRUCTOR_NAME_PROPNAME] = emailMatch.name;
				yammaMail.properties[YammaModel.SENDER_EMAIL_PROPNAME] = emailMatch.email;
...
//				yammaMail.createAssociation(matchingPersons[0], YammaModel.ASSIGNABLE_AUTHORITY_ASSOCNAME);
				...
				yammaMail.properties[YammaModel.RECIPIENT_RECIPIENT_NAME_PROPNAME] = emailMatch.name;
				yammaMail.properties[YammaModel.RECIPIENT_EMAIL_PROPNAME] = emailMatch.email;
