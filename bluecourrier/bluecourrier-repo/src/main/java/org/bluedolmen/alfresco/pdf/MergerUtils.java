...
public final class MergerUtils {
	...
	private static final String MIMETYPE_XPDF = "application/x-pdf";
	 ...
	 */
	public List<NodeRef> getPdfNodeList(Collection<NodeRef> sources) throws ThumbnailException {
	...
	public NodeRef getPdfNode(NodeRef source) throws ThumbnailException {
		
		final String mimetype = getMimetype(source);
		if (MimetypeMap.MIMETYPE_PDF.equals(mimetype) || MIMETYPE_XPDF.equals(mimetype)) {
			return source; 
		}
		
    	NodeRef pdfThumbnail = thumbnailService.getThumbnailByName(source, ContentModel.PROP_CONTENT_PROPERTY_NAME, "pdf"); 
    	...
    	if (null == pdfThumbnail) {
        	...
        	pdfThumbnail = thumbnailService.createThumbnail(source, ContentModel.PROP_CONTENT, MimetypeMap.MIMETYPE_PDF, options, "pdf");
    	}
