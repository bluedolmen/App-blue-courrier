...
import org.bluedolmen.alfresco.reference.ReferenceProviderService.Registerable;
...
public class ReferenceProviderServiceImpl implements ReferenceProviderService, Registerable {
	...
	/**
	 * BEWARE! This code is not reliable from Alfresco 4.2 using SolR.
	 * It should be using a {@link CannedQuery} else it is not reliable to forbid the
	 * setting of a unique reference.
	 */
