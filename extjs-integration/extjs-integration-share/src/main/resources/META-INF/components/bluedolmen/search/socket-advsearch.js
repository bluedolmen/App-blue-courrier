(function() {
    ...
    * @constructor
    */
	Bluedolmen.SocketAdvancedSearch = function(htmlId) {
		Bluedolmen.SocketAdvancedSearch.superclass.constructor.call(this, htmlId);      
		return this;
	};
       
	YAHOO.extend(Bluedolmen.SocketAdvancedSearch, Alfresco.AdvancedSearch, {
		...
		onSearchClick : function ADVSearch_onSearchClick(e, obj) {
			...
			Bluedolmen.Socket.Default.postMessage(message);
