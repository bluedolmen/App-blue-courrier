Ext.define('Bluedolmen.view.forms.window.FormWindow', {
	...
	onFormAction : function(actionId) {
		...
		var firedEventResult = this.fireEvent('formaction', actionId);
		if (false === firedEventResult) return false;
		this.defaultFormActionBehaviour();
		
		firedEventResult = this.fireEvent('form' + actionId);
		if (false === firedEventResult) return false;
