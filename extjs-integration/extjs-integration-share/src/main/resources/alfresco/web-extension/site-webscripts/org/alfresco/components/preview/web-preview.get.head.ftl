...
<!-- Alfresco.WebPreviewer.Plugins.EmbedAsObject -->
<@link rel="stylesheet" type="text/css" href="${page.url.context}/res/components/bluedolmen/preview/EmbedAsObject.css"></@link>
<@script type="text/javascript" src="${page.url.context}/res/components/bluedolmen/preview/EmbedAsObject.js"></@script>
