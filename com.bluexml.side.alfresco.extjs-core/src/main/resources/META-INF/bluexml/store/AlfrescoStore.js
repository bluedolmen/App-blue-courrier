 ...
 * of a Store factory
 */
Ext.define('Bluexml.store.AlfrescoStore', {

	alternateClassName : ['Bluexml.Store'],
	...
	getGroupString : function(instance) {
		...
		var groupField = me.groupers.first();
		if (!groupField) return '';
		
		var groupPropertyName = groupField.property;
		var groupFieldType = instance.fields.get(groupPropertyName).type.type;
