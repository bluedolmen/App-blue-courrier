 ...
 */
 Ext.define('Bluexml.utils.alfresco.Site', {
 
 	requires : [
 		'Bluexml.utils.alfresco.Alfresco',
 		'Bluexml.utils.alfresco.DataList'
 	],
 	...
 	getSiteInformation : function(onSiteInfoRetrieved) {
 		...
 		Bluexml.utils.alfresco.Alfresco.callWebscript(
 			{
	 			url : url,
 	...
 	getDataListData : function(dataListName, onDataRetrieved) {
 		var dataList = Bluexml.utils.alfresco.DataList.create(this.siteName); // should be cached
